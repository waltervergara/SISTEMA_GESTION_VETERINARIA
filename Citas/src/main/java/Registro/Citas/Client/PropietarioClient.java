...
public interface PropietarioClient {
    ...
    @GetMapping("/api/v1/registro/propietarios/buscar/{runPropietario}")
    PropietarioDTO obtenerPropietarioporRun(@PathVariable("runPropietario") String runPropietario);
}
