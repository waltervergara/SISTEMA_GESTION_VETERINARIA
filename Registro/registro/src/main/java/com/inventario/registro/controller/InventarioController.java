...
public class InventarioController {
    ...
    @PostMapping
    public ResponseEntity<?> guardarInvetario(@RequestBody Inventario inventario) {
       try{
    ...
    @PutMapping("/{nombre}")
    public ResponseEntity<?> actualizarInventario(@PathVariable String nombre, @RequestBody Inventario nuevoInventario) {
        try{
